...
require(MVN)
mvn(multivariatenorm2)
mvn<-mvn(multivariatenorm2)
plot(mvn, diagnostic = "multivariate", type = 'qq')
```
...
You can read more [here](https://en.wikipedia.org/wiki/Iris_flower_data_set). It is widely used also in Machine Learning, hence I include it in the curriculum. However, it was promoted by Ronald Fisher, and you can read more about Fisher's Eugenics [here](https://www.newstatesman.com/long-reads/2020/07/ra-fisher-and-science-hatred).
