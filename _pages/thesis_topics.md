...
layout: page
title: Thesis Topics
description: Potential topics for thesis supervision.
...
Hurray! You are thinking about doing your thesis project with me (at any level). On this page I will provide some topics which I would (prefer to) supervise. It also has some further information on the projects. This is still in progress, all feedback welcome. Do also alert me to dead links, which I will fix. Information on the thesis supervision itself can be found [here](/thesis_projects/){:target="_blank"}.
...
* **Proximity and/or gender in voting on _The Weakest Link_.** Researchers at Lincoln found that contestants avoided voting off the person standing directly next to them (a 'neighbour avoidance' effect), and that this effect was stronger when there was less consensus about who the weakest player was. The BBC series offers a fresh dataset for a replication. Note that the findings on gender are mixed, which makes this a good test case.
 ...
 * **Retaliation and bias in _Four in a Bed_.** B&B owners take turns staying at each other's establishments, rate each other anonymously, and then pay what they think their stay was worth. The winner is the B&B that receives the highest percentage of its asking price. Because hosts see their feedback before they visit their rivals, the show lets you test retaliation: do owners who received harsh feedback pay less to, and rate more harshly, the person who criticised them? Underpaying a rival also saves the guest money, so the show adds a financial motive to the competitive one found in _Come Dine With Me_. You can also test more familiar biases, whether ethnic minority owners or same-sex couples are penalised, and whether guests hold more expensive B&Bs to a higher standard. The show has run since 2010, so there is plenty of data.
  * Bolton, G., Greiner, B., & Ockenfels, A. (2013). Engineering trust: Reciprocity in the production of reputation information. _Management Science, 59(2),_ 265–285. [view paper](https://doi.org/10.1287/mnsc.1120.1609){:target="_blank"}
  * Halliday, S. D., & Lafky, J. (2019). Reciprocity through ratings: An experimental study of bias in evaluations. _Journal of Behavioral and Experimental Economics, 83,_ 101480. [view paper](https://doi.org/10.1016/j.socec.2019.101480){:target="_blank"}
  * Ahmed, A. (2013). Co-ethnic preferences in a cooking game: A study based on Come Dine With Me in Sweden. _Ethnic and Racial Studies, 36(12),_ 2220–2236. [view paper](https://doi.org/10.1080/01419870.2012.729671){:target="_blank"}
...
* **Deception detection in _The Circle_.** Contestants interact only via text-based profiles; some play as themselves, others as 'catfish' with a fabricated identity. How accurately do genuine players spot catfish? Do catfish get rated differently? Do gender, age, or similarity predict who gets blocked? Because there are no nonverbal cues, this is a naturally occurring test of text-only deception detection. 
  * DePaulo, B. M., Lindsay, J. J., Malone, B. E., Muhlenbruck, L., Charlton, K., & Cooper, H. (2003).
  Cues to deception. _Psychological Bulletin, 129(1),_ 74–118. [view paper](https://doi.org/10.1037/0033-2909.129.1.74){:target="_blank"}
