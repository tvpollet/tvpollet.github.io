---
title: 'Lecture 7: PY 0794 - Advanced Quantitative Research Methods'
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/Wt94luq6ZY5tS/giphy.gif")
```
...
Data were from [here](https://quantdev.ssri.psu.edu/) but are now avalaible [here](https://tvpollet.github.io/PY_0794/Lecture_7/personality0.txt).  240 participants providing self-ratings (1-9) on 32 variables.
...
```{r, out.width = "300px", echo=FALSE, fig.align='center'}
knitr::include_graphics("https://media.giphy.com/media/3oz8xQQP4ahKiyuxHy/giphy.gif")
```
...
```{r, message=F, warning=F, out.width = "400px", echo=FALSE, fig.align='center'}
require(MVN)
...
```{r, message=F, warning=F, out.width = "300px", fig.align='center'}
require(ggplot2)
require(GGally)
...
```{r, fig.align="center", out.width = "400px", echo=FALSE}
knitr::include_graphics("https://media.giphy.com/media/hTTnsRaU1geWuvUUjB/giphy.gif")
```
