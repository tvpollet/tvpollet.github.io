...
```{r}
#remove the missings
# chose to work in same dataset. (for safety reasons you coula make a new one!)
...
The 95%CI's do not overlap. United [3.22 to 3.89] is significantly slower in terms of arrival time than Delta [1.24 to 2.04].
